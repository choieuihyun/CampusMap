...
## 프로젝트 목적
  ...
  학교 앱에 웹으로 만들어진 지도가 불편하며 접근성이 좋지 않았고, 학교에서 길을 찾을때 떠올리려면 상징성(학교명)을 띠는 교내 지도 앱이 있으면 좋겠다는 생각을 가지고 개발을 시작함.

  학교에 처음 방문하는 사람과 신입생, 재학생까지 포함하여 학교를 방문하는 사람들이 건물, 혹은 강의실을 찾는 것에 어려움을 겪지 않도록 하기 위하여 검색과 메뉴를 동시에 만듦.
