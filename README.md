# 프로젝트 명 : CampusMap_v4(4번째 재개발)

## 프로젝트 목적

  학교 앱에 웹으로 만들어진 지도가 불편하며 접근성이 좋지 않았고, 학교에서 길을 찾을때 떠올리려면 상징성(학교명)을 띠는 교내 지도 앱이 있으면 좋겠다는 생각을 가지고 개발을 시작하였습니다.
...
현재 공학 1관 -> 103 ~ 107 , 115 ~ 118만 완전한 구현 상태.
