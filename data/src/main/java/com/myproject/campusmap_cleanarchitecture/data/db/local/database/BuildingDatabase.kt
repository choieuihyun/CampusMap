...
@Database(entities = [BuildingEntity::class, EngFirstLectureRoomEntity::class], version = 2, exportSchema = false)
...
@Database(entities = [BuildingHistoryEntity::class], version = 1, exportSchema = false)
...
@Database(entities = [BuildingFavoriteEntity::class], version = 1, exportSchema = false)
