...
object NetworkModule {
    ...
    // 일반 공지사항 링크
    private const val JSOUP_GENERAL_LINK_URL = "https://www.jj.ac.kr/jj/community/notice/gennotice.jsp"

    // 학사 공지사항 홈페이지 (1페이지)
    private const val JSOUP_HAKSA_BASE_URL = "https://www.jj.ac.kr/jj/community/notice/haksanotice.jsp?mode=list&board_no=1076&pager.offset="
    // 학사 공지사항 링크
    private const val JSOUP_HAKSA_LINK_URL = "https://www.jj.ac.kr/jj/community/notice/haksanotice.jsp"

    // 장학 공지사항 홈페이지 (1페이지)
    private const val JSOUP_JANGHAK_BASE_URL = "https://www.jj.ac.kr/jj/community/notice/janghaknotice.jsp?mode=list&board_no=1077&pager.offset="
    // 장학 공지사항 링크
    private const val JSOUP_JANGHAK_LINK_URL = "https://www.jj.ac.kr/jj/community/notice/janghaknotice.jsp"

    // 취업 공지사항 홈페이지 (1페이지)
    private const val JSOUP_RECRUIT_BASE_URL = "https://www.jj.ac.kr/jj/education/recruit/recruitinfo.jsp?mode=list&board_no=1070&pager.offset="
    // 취업 공지사항 링크
    private const val JSOUP_RECRUIT_LINK_URL = "https://www.jj.ac.kr/jj/education/recruit/recruitinfo.jsp"
