...
import com.campusmap.android.campusmap_with_kakao.databinding.NoticeGeneralFragmentBinding
...
class NoticeGeneralFragment : Fragment() {

    private lateinit var binding: NoticeGeneralFragmentBinding
    private lateinit var noticeGeneralRecyclerView: RecyclerView
    ...
    private val noticeGeneralListViewModel: NoticeFragmentViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch { // 네트워크같은 작업이 IO
            ...
            noticeGeneralListViewModel.loadHaksaNoticeItems()

            noticeArray = noticeGeneralListViewModel.getNoticeItems
...
//                Log.d("NoticeFragment4", returnValue.await().toString())
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.notice_general_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        noticeGeneralRecyclerView = view.findViewById(R.id.noticeGeneral_RecyclerView) as RecyclerView
        noticeGeneralRecyclerView.layoutManager = LinearLayoutManager(context)
        noticeGeneralRecyclerView.adapter = adapter
