...
import com.campusmap.android.campusmap_with_kakao.databinding.NoticeHaksaFragmentBinding
...
class NoticeHaksaFragment : Fragment() {

    private lateinit var binding: NoticeHaksaFragmentBinding
    private lateinit var noticeHaksaRecyclerView: RecyclerView
    ...
    private val noticeHaksaListViewModel: NoticeFragmentViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch { // 네트워크같은 작업이 IO
            ...
            noticeHaksaListViewModel.loadHaksaNoticeItems()

            noticeArray = noticeHaksaListViewModel.getNoticeItems
...
//                Log.d("NoticeFragment4", returnValue.await().toString())
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.notice_haksa_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        noticeHaksaRecyclerView = view.findViewById(R.id.noticeHaksa_RecyclerView) as RecyclerView
        noticeHaksaRecyclerView.layoutManager = LinearLayoutManager(context)
        noticeHaksaRecyclerView.adapter = adapter
