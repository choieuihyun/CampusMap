...
import com.campusmap.android.campusmap_with_kakao.databinding.NoticeRecruitFragmentBinding
...
class NoticeRecruitFragment : Fragment() {

    private lateinit var binding: NoticeRecruitFragmentBinding
    private lateinit var noticeRecruitRecyclerView: RecyclerView
    ...
    private val noticeRecruitListViewModel: NoticeFragmentViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.IO).launch { // 네트워크같은 작업이 IO
            ...
            noticeRecruitListViewModel.loadRecruitNoticeItems()

            noticeArray = noticeRecruitListViewModel.getNoticeItems
...
//                Log.d("NoticeFragment4", returnValue.await().toString())
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.notice_recruit_fragment, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        noticeRecruitRecyclerView = view.findViewById(R.id.noticeRecruit_RecyclerView) as RecyclerView
        noticeRecruitRecyclerView.layoutManager = LinearLayoutManager(context)
        noticeRecruitRecyclerView.adapter = adapter
